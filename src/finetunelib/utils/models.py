...
from finetunelib.prompt_tokenizers import LLAMA_DEFAULT_EOS_TOKEN
from finetunelib.utils.bench import log_gpu_memory_usage
...
def load_model(
    ...
    if cfg.is_llama_derived_model and cfg.flash_attention:
        if cfg.device not in ["mps", "cpu"] and not inference:
            from finetunelib.monkeypatch.llama_attn_hijack_flash import (
        ...
        from finetunelib.monkeypatch.llama_attn_hijack_xformers import (
        ...
        from finetunelib.monkeypatch.llama_attn_hijack_sdp import hijack_llama_sdp_attention
    ...
    if cfg.is_llama_derived_model and cfg.xpos_rope:
        from finetunelib.monkeypatch.xpos_rope_llama_monkey_patch import (
    ...
    if (
        ...
        from finetunelib.monkeypatch.llama_expand_mask import hijack_expand_mask
