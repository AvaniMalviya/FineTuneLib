...
from finetunelib.utils.distributed import (
    barrier,
    broadcast_dict,
...
if TYPE_CHECKING:
    from finetunelib.utils.trainer import FineTuneLibTrainingArguments

LOG = logging.getLogger("finetunelib.callbacks")
IGNORE_INDEX = -100
...
def bench_eval_callback_factory(trainer, tokenizer):
    ...
    class BenchEvalCallback(TrainerCallback):
        ...
        def on_evaluate(
            self,
            args: FineTuneLibTrainingArguments,
